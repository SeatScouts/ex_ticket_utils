defmodule ExTicketUtils.Pos.Invoices.LineItemsTest do
  use ExUnit.Case
  ...
  test "#v2 Pos.Inventory.search", %{server: server, client: client} do
    Bypass.expect(server, fn conn ->
      assert "/POS/Invoices/LineItems" == conn.request_path
    ...
    {:ok, response} =
      ExTicketUtils.Pos.Invoices.LineItems.search(client, %{"Id" => 12345}, version: "v2")
  ...
  test "#v3 Pos.Inventory.search", %{server: server, client: client} do
    Bypass.expect(server, fn conn ->
      assert "/POS/Sales/InvoiceItems/Search" == conn.request_path
    ...
    {:ok, response} =
      ExTicketUtils.Pos.Invoices.LineItems.search(client, %{"Id" => 12345}, version: "v3")
